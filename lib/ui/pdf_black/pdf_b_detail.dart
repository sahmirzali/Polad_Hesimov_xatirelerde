...
class PageIndexBlack extends StatefulWidget {
  final Completer<PDFViewController> control;
  PageIndexBlack({Key key, this.control}) : super(key: key);

  @override
  _PageIndexBlackState createState() => _PageIndexBlackState();
}

class _PageIndexBlackState extends State<PageIndexBlack> {
